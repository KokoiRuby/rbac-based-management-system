...
type UserRDB interface {
	...
	DeleteByCond(c context.Context, conds ...gen.Condition) (int64, error)
	DeleteByID(c context.Context, id uint) (int64, error)
	DeleteByIDs(c context.Context, id []uint) (int64, error)
}
